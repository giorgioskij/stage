...
from stage.models.quantization.base import QuantizedResult
from stage.models import quantization as qt
from stage import hyperparameters as hp
# from modules import SEANetDecoder, SEANetEncoder

# audiocraft imports
with contextlib.redirect_stderr(open(os.devnull, "w")):
    from stage.models.modules import SEANetEncoder, SEANetDecoder
