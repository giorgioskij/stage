...
from lag.cocola import constants
...
class EfficientNetEncoder(nn.Module):
    ...
    def __init__(self, dropout_p, in_channels: int = 2) -> None:
        ...
        self.model = nn.Sequential(
            ...
            nn.Dropout(self.dropout_p), nn.Flatten())
...
class CoColaEncoder(nn.Module):
    ...
    def __init__(self,
                 ...
                 input_type: constants.ModelInputType = constants.
                 ModelInputType.DOUBLE_CHANNEL_HARMONIC_PERCUSSIVE,
...
class CoCola(L.LightningModule):
    ...
    def __init__(self,
                 ...
                 embedding_dim: int = 512,
                 embedding_mode: constants.EmbeddingMode = constants.
    ...
    def score(self, x: torch.Tensor, y: torch.Tensor) -> torch.Tensor:
        ...
        x_embeddings, y_embeddings = torch.split(data_embeddings,
                                                 data_embeddings.size(0) // 2,
                                                 dim=0)
