    ...
    if __name__ == "__main__":
        ...
        conditioning_params = hp.ConditioningParams(
            embedder_types={
                ...
                ConditionType.STYLE: SequenceClapEmbedder
            },
        ...
        bard_params = hp.MusicgenParams(encodec_params=encodec_params,
