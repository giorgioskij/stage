...
# from lag.conditioning.prompt_processor import PromptProcessor
from lag.conditioning import ConcreteEmbedder
from lag.data.stem import Stem
from lag.utils.logging import to_loggable
...
class EncodecParams(ModelParams):
    ...
    model_class: str = "lag.models.lightning_encodec.LightningEncodec"
...
class LmParams(ModelParams):
    ...
    weights: Optional[str] = None
    model_class: str = "lag.models.musicgen_lm.MusicgenLm"
...
class MusicgenParams(ModelParams):
    ...
    model_class: str = "lag.models.lightning_musicgen.LightningMusicgen"
...
class StemmedDatasetParams(DatasetParams):
    ...
    datamodule_class: str = "lag.data.stemmed_datamodule.StemmedDatamodule"
